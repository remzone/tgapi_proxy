...
func servePlaceholder(w http.ResponseWriter) {
	...
	w.Header().Set("Content-Security-Policy", "default-src 'none'; img-src https://images.unsplash.com; style-src 'unsafe-inline'; base-uri 'none'; frame-ancestors 'none'")
